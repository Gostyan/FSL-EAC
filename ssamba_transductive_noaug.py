#!/usr/bin/env python3
"""
SSAMBA Transductive Fine-Tuning (No Augmentation) - Baseline

Baseline version to verify the effect of SpecAugment data augmentation.

- Support Set: Feature extraction -> Initialize classifier W from prototypes -> CE loss (NO augmentation)
- Query Set: Feature extraction -> Entropy regularization loss (encourage low-entropy predictions)
- Total loss = Support CE + lambda * Query Entropy
- Update parameters: theta (encoder), W, b

Key difference from original:
- Original: aug_factor=4, support set expanded 4x with SpecAugment
- This baseline: aug_factor=1, NO data augmentation
"""
...
# from specaugment import get_specaugment_light  # Disabled for baseline
...
def main():
    ...
    parser.add_argument("--batch_size", type=int, default=25, help="Batch size for processing")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--cpu", action="store_true")
    parser.add_argument("--save_path", default="ssamba_transductive_noaug_best.pth")
    ...
    print("=" * 70)
    print("  SSAMBA Transductive Fine-Tuning (No Augmentation) - Baseline")
    print("=" * 70)
    ...
    print(f"[Config] Augmentation: DISABLED (aug_factor={args.aug_factor})")
    ...
    augmenter = None  # Force disable augmentation
